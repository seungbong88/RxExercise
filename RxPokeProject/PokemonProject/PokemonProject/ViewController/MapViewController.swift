...
class MapViewController: UIViewController {
  ...
  var rxTotalHabitat = PublishSubject<TotalHabitat>()
...
//    }
    ...
    NetworkAgent.shared.rxRequestGet(NetworkConstants.habitateAPI)
      .subscribe { habitat in
        self.totalHabitat = TotalHabitat(json: habitat)
      } onError: { <#Error#> in
        <#code#>
      } onCompleted: {
        <#code#>
